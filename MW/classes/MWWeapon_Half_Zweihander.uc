class MWWeapon_Half_Zweihander extends AOCWeapon_Halberd;
...
DefaultProperties
{
	...
	AttachmentClass=class'MWWeaponAttachment_Half_Zweihander'
	InventoryAttachmentClass=none

	AlternativeMode=class'MWWeapon_Zweihander'

	WeaponFontSymbol="?"

	WindupAnimations(0)=(AnimationName=3p_halberd_slash01downtoup,ComboAnimation=3p_halberd_slash011downtoup,AlternateAnimation=3p_halberd_slash011altdowntoup,AssociatedSoundCue=,bFullBody=False,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.625,fBlendInTime=0.10,fBlendOutTime=0.00,bLastAnimation=false)
